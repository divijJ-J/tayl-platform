  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="space-y-2">
        {invoices?.map((inv) => (
          <div key={inv.id} className="border border-slate-200 rounded px-4 py-3">
            <div className="flex justify-between items-start">
              ...
              {inv.status === 'paid' && (
                <span className="text-sm text-green-600 border border-green-600/40 rounded px-3 py-1.5">
                  Paid
                </span>
              )}
            </div>

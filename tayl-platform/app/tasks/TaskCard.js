  ...
  return (
    <div className="border border-white/10 rounded px-3 py-2 text-sm">
      ...
      <select
        ...
        className="w-full mt-2 bg-[#12131A]/5 border border-white/10 rounded px-2 py-1 text-xs"
      >
        {columns.map((c) => (
      ...
      <div className="mt-2 flex items-center gap-2">
        <input
          ...
          className="flex-1 bg-[#12131A]/5 border border-white/10 rounded px-2 py-1 text-xs"
        />
      ...
      {showComments && (
        <div className="mt-2 space-y-1">
          {comments.map((c) => (
            <div key={c.id} className="text-xs bg-[#12131A] rounded px-2 py-1">
              {c.comment}
            </div>
          ))}
